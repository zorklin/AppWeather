...
namespace AppWeather.Presentation.ViewModels
{
    public partial class FiltrationViewModel : ObservableObject
    {
        ...
        [ObservableProperty] private string minTemperature = "";
        [ObservableProperty] private string maxTemperature = "";
        [ObservableProperty] private string precipitation = "";
        [ObservableProperty] private string minPressure = "";
        [ObservableProperty] private string maxPressure = "";
